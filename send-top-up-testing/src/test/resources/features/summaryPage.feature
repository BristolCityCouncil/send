...
Feature: Needs Assessment - high level summary page - TC32294
  ...
  Scenario: User can view Needs areas and links - [TC32443 -> TC32449] [TC32532 -> TC32538]
  ...
  Scenario: User can navigate to sub area Needs pages - [TC32539]
    Given user views assessment without any Needs or Provisions selected
  ...
  Scenario: User can navigate to sub area Needs pages - [TC32540]
    Given user views assessment without any Needs or Provisions selected
  ...
  Scenario: User can navigate to sub area Needs pages - [TC32541]
    Given user views assessment without any Needs or Provisions selected
  ...
  Scenario: User can navigate to sub area Needs pages - [TC32542]
    Given user views assessment without any Needs or Provisions selected
    When user clicks link for Behaviours for learning
    Then page title contains the text "Behaviours for learning"

  Scenario: User can navigate to sub area Needs pages - [TC32543]
    Given user views assessment without any Needs or Provisions selected
  ...
  Scenario: User can navigate to sub area Needs pages - [TC32544]
    Given user views assessment without any Needs or Provisions selected
  ...
  Scenario: User can navigate to sub area Needs pages - [TC32548]
    Given user views assessment without any Needs or Provisions selected
