...
Feature: Cognition and Learning
  ...
  Scenario: Academic learning Needs and Provisions
    Given assessment wih Cognition and learning Need "Block C" selected
    ...
    And under Academic learning > Specialist Professional Provision - user selects "Specialist professional advice and support 1" option "2"
