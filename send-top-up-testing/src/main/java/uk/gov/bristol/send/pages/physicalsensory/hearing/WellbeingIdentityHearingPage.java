...
@Component
public class WellbeingIdentityHearingPage extends AccordionPage {

    @FindBy(id = "A4SA9SC5SG9_accordion")
    private WebElement accordionBtn;

    @FindBy(id = "A4SA9SC5SG9STT1")
    private WebElement statementTargeted;

    @FindBy(id = "A4SA9SC5SG9STA1")
    private WebElement statementLevelA;

    @FindBy(id = "A4SA9SC5SG9STB1")
    private WebElement statementLevelB;

    @FindBy(id = "A4SA9SC5SG9STC1")
    private WebElement statementLevelC;

    @FindBy(id = "A4SA9SC5SG9_clear")
    private WebElement clearSelectionBtn;

    public WellbeingIdentityHearingPage(WebDriver webDriver) {
        super(webDriver);
