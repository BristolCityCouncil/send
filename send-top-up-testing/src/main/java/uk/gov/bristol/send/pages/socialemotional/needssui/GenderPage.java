...
@Component
public class GenderPage extends AccordionPage {

    @FindBy(id = "A3SA5SC7SG14_accordion")
    private WebElement accordionBtn;

    @FindBy(id = "A3SA5SC7SG14STT1")
    private WebElement statementTargeted;

    @FindBy(id = "A3SA5SC7SG14STA1")
    private WebElement statementLevelA;

    @FindBy(id = "A3SA5SC7SG14STB1")
    private WebElement statementLevelB;

    @FindBy(id = "A3SA5SC7SG14STC1")
    private WebElement statementLevelC;

    @FindBy(id = "A3SA5SC7SG14_clear")
    private WebElement clearSelectionBtn;

    public GenderPage(WebDriver webDriver) {
        super(webDriver);
