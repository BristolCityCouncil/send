...
@Component
public class AttentionConcentrationPage extends AccordionPage {

    @FindBy(id = "A2SA4SC5SG8_accordion")
    private WebElement accordionBtn;

    @FindBy(id = "A2SA4SC5SG8STT1")
    private WebElement statementTargeted;

    @FindBy(id = "A2SA4SC5SG8STA1")
    private WebElement statementLevelA;

    @FindBy(id = "A2SA4SC5SG8STB1")
    private WebElement statementLevelB;

    @FindBy(id = "A2SA4SC5SG8STC1")
    private WebElement statementLevelC;

    @FindBy(id = "A2SA4SC5SG8_clear")
    private WebElement clearSelectionBtn;

    public AttentionConcentrationPage(WebDriver webDriver) {
        super(webDriver);
