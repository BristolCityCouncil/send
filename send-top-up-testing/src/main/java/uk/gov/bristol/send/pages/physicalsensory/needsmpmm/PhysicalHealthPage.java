...
@Component
public class PhysicalHealthPage extends AccordionPage {

    @FindBy(id = "A4SA7SC1SG1_accordion")
    private WebElement accordionBtn;

    @FindBy(id = "A4SA7SC1SG1STT1")
    private WebElement statementTargeted;

    @FindBy(id = "A4SA7SC1SG1STA1")
    private WebElement statementLevelA;

    @FindBy(id = "A4SA7SC1SG1STB1")
    private WebElement statementLevelB;

    @FindBy(id = "A4SA7SC1SG1STC1")
    private WebElement statementLevelC;

    @FindBy(id = "A4SA7SC1SG1_clear")
    private WebElement clearSelectionBtn;

    public PhysicalHealthPage(WebDriver webDriver) {
        super(webDriver);
