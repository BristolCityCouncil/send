...
@Component
public class HealthAnxietyPage extends AccordionPage {

    @FindBy(id = "A4SA7SC3SG6_accordion")
    private WebElement accordionBtn;

    @FindBy(id = "A4SA7SC3SG6STT1")
    private WebElement statementTargeted;

    @FindBy(id = "A4SA7SC3SG6STA1")
    private WebElement statementLevelA;

    @FindBy(id = "A4SA7SC3SG6STB1")
    private WebElement statementLevelB;

    @FindBy(id = "A4SA7SC3SG6STC1")
    private WebElement statementLevelC;

    @FindBy(id = "A4SA7SC3SG6_clear")
    private WebElement clearSelectionBtn;

    public HealthAnxietyPage(WebDriver webDriver) {
        super(webDriver);
