...
@Component
public class PhysicalSafetyHearingPage extends AccordionPage {

    @FindBy(id = "A4SA9SC4SG7_accordion")
    private WebElement accordionBtn;

    @FindBy(id = "A4SA9SC4SG7STT1")
    private WebElement statementTargeted;

    @FindBy(id = "A4SA9SC4SG7STA1")
    private WebElement statementLevelA;

    @FindBy(id = "A4SA9SC4SG7STB1")
    private WebElement statementLevelB;

    @FindBy(id = "A4SA9SC4SG7STC1")
    private WebElement statementLevelC;

    @FindBy(id = "A4SA9SC4SG7_clear")
    private WebElement clearSelectionBtn;

    public PhysicalSafetyHearingPage(WebDriver webDriver) {
        super(webDriver);
