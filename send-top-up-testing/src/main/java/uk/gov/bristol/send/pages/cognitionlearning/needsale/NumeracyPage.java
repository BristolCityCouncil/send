...
@Component
public class NumeracyPage extends AccordionPage {

    @FindBy(id = "A2SA3SC6SG9_accordion")
    private WebElement accordionBtn;

    @FindBy(id = "A2SA3SC6SG9STT1")
    private WebElement statementTargeted;

    @FindBy(id = "A2SA3SC6SG9STA1")
    private WebElement statementLevelA;

    @FindBy(id = "A2SA3SC6SG9STB1")
    private WebElement statementLevelB;

    @FindBy(id = "A2SA3SC6SG9STC1")
    private WebElement statementLevelC;

    @FindBy(id = "A2SA3SC6SG9_clear")
    private WebElement clearSelectionBtn;

    public NumeracyPage(WebDriver webDriver) {
        super(webDriver);
