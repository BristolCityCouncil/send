...
@Component
public class OrganisationForLearningPage extends AccordionPage {

    @FindBy(id = "A2SA4SC3SG4_accordion")
    private WebElement accordionBtn;

    @FindBy(id = "A2SA4SC3SG4STT1")
    private WebElement statementTargeted;

    @FindBy(id = "A2SA4SC3SG4STA1")
    private WebElement statementLevelA;

    @FindBy(id = "A2SA4SC3SG4STB1")
    private WebElement statementLevelB;

    @FindBy(id = "A2SA4SC3SG4STC1")
    private WebElement statementLevelC;

    @FindBy(id = "A2SA4SC3SG4_clear")
    private WebElement clearSelectionBtn;

    public OrganisationForLearningPage(WebDriver webDriver) {
        super(webDriver);
